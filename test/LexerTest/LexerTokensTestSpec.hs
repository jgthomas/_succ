  ...
  describe "Lex input string into tokens" $ do
    it "Should correctly lex all syntactic characters" $
      ( dummyData $
        ...
        `shouldBe` [ OpenBracket OpenParen dummyLexDat,
    ...
    it "Should correctly lex valid identifiers" $
      ( dummyData $
        ...
        `shouldBe` [ Ident "main" dummyLexDat,
    ...
    it "Should correctly lex all single-character operators" $
      ( dummyData $
        ...
        `shouldBe` [ OpTok PlusSign dummyLexDat,
    ...
    it "Should correctly lex all two-character operators" $
      ( dummyData $
        ...
        `shouldBe` [ OpTok PipePipe dummyLexDat,
    ...
    it "Should correctly lex easily confused operators" $
      ( dummyData $
        ...
        `shouldBe` [OpTok PlusPlus dummyLexDat, OpTok PlusSign dummyLexDat, OpTok PlusEqual dummyLexDat]
    it "Should correctly lex valid numbers" $
      ( dummyData $
          concatMap (fromRight [] . tokenize) ["123", "1", "0"]
      )
        `shouldBe` [ConstInt 123 dummyLexDat, ConstInt 1 dummyLexDat, ConstInt 0 dummyLexDat]
